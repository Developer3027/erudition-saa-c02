export const quizsData = [
  ...
  {
    id: "architect-for-availability-and-reliability",
    result: [
      {
        id: 1,
        ...
        options: [
          {
            id: 1,
            text: "The app or site can be reached. It is running and healthy. The percentage of time it is performing as expected.",
            correct: true,
          },
          {
            id: 2,
            text: "The app or site can not be reached",
            correct: false,
          },
          {
            id: 3,
            text: "You have given out your number",
            correct: false,
          },
          {
            id: 4,
            text: "Also known as uptime, or how long the site is up.",
            correct: false,
          },
        ],
      },
      {
        id: 2,
        question: "What is an indication you have poor availability?",
        options: [
          {
            id: 1,
          ...
          {
            id: 2,
            text: "Performs better than expected",
            correct: false,
          },
          {
            id: 3,
            text: "Anyone can reach it anywhere at anytime",
            correct: false,
          },
          {
            id: 4,
            text: "I do not know, I am here to learn",
            correct: false,
          },
        ],
      },
      {
        id: 3,
        question:
          "How long can you expect to be down per year at 99.0% availability?",
        options: [
          {
            id: 1,
            text: "3 days 15 hours",
            correct: true,
          },
          {
            id: 2,
            text: "8 hours 45 minutes",
            correct: false,
          },
          {
            id: 3,
      ...
      },
      {
        id: 4,
        question:
          "What is the expected annual downtime if you have 99.9% availability?",
        options: [
          {
            id: 1,
            text: "8 hours 45 minutes",
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: 2,
            text: "Standard Level Arrangement",
            correct: false,
          },
          {
            id: 3,
            text: "Simply Leverage Sarah",
            correct: false,
          },
          {
            id: 4,
            text: "Standard Level Annoyance",
            correct: true,
          },
        ],
      },
  ...
  {
    id: "aws-vpc-from-the-cli",
    result: [
      {
        id: 1,
        question: "A subnet in a VPC can expand across multiply availability zones",
        options: [
          {
            id: 1,
            text: "No, a VPC contains one or more subnets. A subnet exists in an availability zone. An instance exists in a subnet.",
            correct: true,
          },
          {
            id: 2,
            text: "Yes, of course. This is AWS and anything is possible.",
            correct: false,
          },
          {
            id: 3,
            text: "Depends on your needs and how much you are willing to pay.",
            correct: false,
          },
          {
            id: 4,
            text: "Light travels really fast, like super fast with boost times 10 fast.",
            correct: false,
          },
        ],
      },
      {
        id: 2,
        question: "The AWS VPC is a foundational service provided by AWS that allows one to have an isolated public cloud network in which to create and run various services or networks.",
        options: [
          {
            id: 1,
            text: "True",
      ...
      },
      {
        ...
        options: [
          {
            id: 1,
            text: "Basically a data center.",
            correct: true,
          },
          {
            id: 2,
            text: "A large geographical region like, France.",
            correct: false,
          },
          {
            id: 3,
            text: "Designated time within your day to call your mom.",
            correct: false,
          },
          {
            id: 4,
            text: "Specific street corners, only known to locals, where specific goods and services can be traded.",
            correct: false,
          },
        ],
      },
      {
        id: 4,
        question:
          "How many ways can you access your VPC",
        options: [
          {
            id: 1,
            text: "3. Internet access, VPN access, Direct Connect",
            correct: true,
          },
          {
            id: 2,
            text: "Only over the internet",
            correct: false,
          },
          {
            id: 3,
            text: "Any choice that gets you to grandma",
            correct: false,
          },
          {
            id: 4,
            text: "Is ssh a thing? Like http, sometimes with an s?",
            correct: false,
          },
        ],
      },
      {
        id: 5,
        question: "The Transit Gateway can connect VPC's together, connect VPN to external networks and is highly available.",
        options: [
          {
            id: 1,
            text: "True",
